...
function apply_fractions_one_hour(task,cb){
    ...
    _.forEach(task.fractions, function(cell_fractions, cellid){
        ...
        // fetch the aadt fort this cell
        var aadt_grid = task.aadt_store[cellid]
        ...
        _.forEach(aadt_grid,function(aadt_record,index){
            // write out lane miles and initialize structure
            var road_class = aadt_record.road_type
            ...
            _.each(nhh_vars,function(k2){
                ...
                task.accum[cellid][road_class][k2] =
                    cell_fractions.nhh * scale.nhh * aadt_record[k2]
                return null
            })
            _.each(n_vars,function(k2){
                // multiply by n
                task.accum[cellid][road_class][k2] =
                    cell_fractions.n * scale.n * aadt_record[k2]
                return null
            })
            ...
            _.each(hh_vars,function(k2){
                // multiply by hh
                task.accum[cellid][road_class][k2] =
                    cell_fractions.hh * scale.hh * aadt_record[k2]
                return null
            })
            return null
        })
...
exports.apply_fractions=apply_fractions_one_hour
